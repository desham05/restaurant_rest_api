...
public class MenuHome {
	...
	public Menu merge(Menu detachedInstance) {
		...
		try {
			Menu result = (Menu) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Menu findById(java.lang.Integer id) {
		...
		try {
			Menu instance = (Menu) sessionFactory.getCurrentSession().get("com.org.generated.Menu", id);
			if (instance == null) {
	...
	public List<Menu> findByExample(Menu instance) {
		...
		try {
			List<Menu> results = (List<Menu>) sessionFactory.getCurrentSession()
					.createCriteria("com.org.generated.Menu").add(create(instance)).list();
