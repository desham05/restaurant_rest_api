...
public class ItemHome {
	...
	public Item findById(java.lang.Integer id) {
		...
		try {
			Item instance = (Item) sessionFactory.getCurrentSession().get("com.org.generated.Item", id);
			if (instance == null) {
	...
	public List<Item> findByExample(Item instance) {
		...
		try {
			List<Item> results = (List<Item>) sessionFactory.getCurrentSession()
					.createCriteria("com.org.generated.Item").add(create(instance)).list();
